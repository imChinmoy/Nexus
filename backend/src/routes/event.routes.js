...
router.post('/', authorize(ROLES.COORDINATOR), createEventValidator, validate, eventController.create);
router.put('/:id', authorize(ROLES.COORDINATOR), updateEventValidator, validate, eventController.update);
